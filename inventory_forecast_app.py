...
st.set_page_config(page_title="NextMind AI — Book Forecasting Tool", layout="centered")

# Logo and Title
st.image("https://via.placeholder.com/150x50.png?text=NextMind+AI", width=200)
